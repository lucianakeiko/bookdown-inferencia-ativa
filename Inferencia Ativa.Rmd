...
\begin{matrix}\underbrace{+ \mathbb E[] } \\ Ganho\;de\;informação\;de\;parâmetro \end{matrix} \\
\begin{matrix}\underbrace{= - \mathbb E[] } \\ Saliência \end{matrix} \\
\begin{matrix}\underbrace{- \mathbb E[] } \\ novidade \end{matrix} -
\begin{matrix}\underbrace{\mathbb E[] } \\ Valor\;pragmático \end{matrix} 
\end{equation}
$$
