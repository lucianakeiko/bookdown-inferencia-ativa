...
## Preferências anteriores e estados iniciais
...
O trabalho pesado é completado nos bastidores pela função spm_MDP_VB_X, que implementa a passagem de mensagens e a seleção de políticas descritas nos capítulos 4 e 7. Além disso, simula o mundo que nossa criatura deve enfrentar, incluindo transições entre estados e a geração de resultados . Poderíamos ter incluído muitas outras opções; para detalhes, nós indicamos aos leitores a documentação desta função no script Matlab.
