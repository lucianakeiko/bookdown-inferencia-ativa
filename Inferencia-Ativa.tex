...
\frac{1}{a_{ij}} - \frac{1}{a_{0j}} + \ln \frac{a_{0j}}{a_{ij}}+\psi(a\_\{ij\})-\psi(a\_\{0j\}) \qquad (B.33) \textbackslash{}
...
\$\$
F{[}P(\theta){]}-F{[}\tilde P(\theta){]} = \ln \mathbb E\_\{Q(\theta)\}\Big[\frac{\tilde P(\theta)}{P(\theta)}\Big]  \qquad (B.39)\textbackslash{}
\ln \tilde Q(\theta) = \ln Q(\theta) + \ln \tilde P(\theta) - \ln P(\theta) - \ln \mathbb E\_\{Q(\theta)\}\Big[\frac{\tilde P(\theta)}{P(\theta)}\Big] 
