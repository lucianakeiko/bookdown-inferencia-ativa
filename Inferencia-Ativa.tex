...
Transformar decisões sobre locais de alvos discretos em movimentos oculares contínuos requer que cada local de alvo discreto \((o)\) seja associado a uma distribuição sobre causas ocultas contínuas \((\nu)https://tex.stackexchange.com/questions/6969/symbol-for-gaussian-distribution\), que identifica as coordenadas do alvo. As coordenadas anteriores sobre o alvo podem ser calculadas tomando a média do modelo Bayesiano sobre esses locais, ponderada pelas inferências no nível POMDP:
